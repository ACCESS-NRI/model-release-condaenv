...
- **`payu`**:
 ...
 ```shell
  ...
  $ module load payu/1.1.6 # To load a specific version
...
- **`deploy.sh`** (optional):
 This script runs once the environment has been deployed. It is useful for updating the stable or default alias for a modulefile.
